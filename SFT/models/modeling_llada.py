...
class LLaDAModel(LLaDAPreTrainedModel):
    ...
    def forward(
        ...
        output_last_hidden_state = (
            output_last_hidden_state if output_last_hidden_state is not None else False
        )
        ...
        return LLaDAOutput(
            ...
            if (output_hidden_states or output_last_hidden_state) else None,
